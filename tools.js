// we need http for making download requests
...
var downloadExist = function(host, path, callback){
...
exports.downloadExist = downloadExist;
...
var fs = require ('fs');
var download = function(host, path, filename, cb){
    var options = {host: host, port: 80, path: path, method: 'GET'};
    ...
    var req = http.request(options, function(res) {
        ...
        res.on('end', function(){
            file.end();
            if (isset(cb)) require('fs').exists(filename, cb);
        });
    });
...
// unserialises php objects (useful for WordPress functions)
...
exports.urlReq = function(reqUrl, options, cb){
    ...
    // parse url to chunks
    reqUrl = require("url").parse(reqUrl);
